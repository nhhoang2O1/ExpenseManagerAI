...
namespace ExpenseManager.Api.Data.Migrations
{
    ...
    [Migration("20260730092028_HardenDatabaseIntegrity")]
            ...
            modelBuilder.Entity("ExpenseManager.Api.Domain.GoalHistory", b =>
                {
                    ...
                    b.ToTable("goal_histories", t =>
                        {
                            t.HasCheckConstraint("ck_goal_histories_amounts", "amount_added > 0 AND (requested_amount IS NULL OR requested_amount > 0) AND (balance_after IS NULL OR balance_after >= 0)");
                        });
                });
