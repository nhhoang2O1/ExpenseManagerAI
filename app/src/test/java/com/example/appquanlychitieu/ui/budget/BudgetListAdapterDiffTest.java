...
public class BudgetListAdapterDiffTest {
    ...
    public void backendIdDefinesIdentity() {
        Budget first = budget("budget-1", 1_000_000d);
        Budget same = budget("budget-1", 1_000_000d);
        Budget changed = budget("budget-1", 2_000_000d);
    ...
    private Budget budget(String id, double amount) {
